    ...
    load() {
        return new Promise(resolve => {
            requestAnimationFrame(async () => {
                const query = this.getAttribute("for");
                this.#container = this.parentElement.querySelector(query) || this.parentElement.shadowRoot.querySelector(query);
                // this.#container = this.parentElement.shadowRoot.querySelector(query);
                console.log("Filter Header", this.parentElement);
