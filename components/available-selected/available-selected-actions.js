/**
 * @class AvailableSelectedActions - Actions for the available-selected component
 *
 * Features:
 * - set_records - This action will set the records for the available and selected lists.
 * - get_selected_records - This action will return the selected records.
 */
