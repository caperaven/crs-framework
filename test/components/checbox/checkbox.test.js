...
//
//     it("initial state for normal checkbox", () => {
//         checkbox.isTristate = false;
//         checkbox.setAttribute("aria-checked", true);
//         assertEquals(checkbox.getAttribute("aria-checked"), true);
//     });
//
//     it("change state for normal checkbox on click", () => {
//         assertEquals(checkbox.getAttribute("aria-checked"), true);
//         checkbox.click();
//         assertEquals(checkbox.getAttribute("aria-checked"), false);
//     });
...
//     it("initial state for normal checkbox", () => {
//         checkbox.setAttribute("aria-checked", true);
//         assertEquals(checkbox.getAttribute("aria-checked") === "true", true);
//     });
//
//     it("change state for normal checkbox on click", async () => {
//         assertEquals(checkbox.getAttribute("aria-checked") === "true", true);
//         const button = checkbox.shadowRoot.querySelector("button[role='checkbox']");
//         button.dispatchEvent(new Event("click"));
//         assertEquals(checkbox.getAttribute("aria-checked") === "false", false);
//     });
// });
