...
describe("Calendar Component", async () => {
    ...
    it('should move to next month on keydown event', async () => {
        // Arrange


        // Act
        instance.setAttribute("data-start", "2023-02-23");
        instance.shadowRoot.performEvent("keydown", null, {key: "ArrowDown"});
        // Assert
